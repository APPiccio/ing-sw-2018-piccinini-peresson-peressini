...
public class ToolCard12 extends ToolCard {
    ...
    public boolean paramsOk(ToolCardParameterContainer container) {
        ...
        if((toolCardParameters.secondPanelCellIndex == toolCardParameters.panelCellIndex)||(toolCardParameters.panelDiceIndex == toolCardParameters.secondPanelDiceIndex)) return false;
