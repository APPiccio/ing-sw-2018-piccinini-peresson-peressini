...
public class ReconnectionResponseTest {
    ...
    public void handle() {
        ...
        ResponseHandler handler = new ResponseHandler() {
            ...
            public void handle(ReconnectionResponse response) {
                assertEquals(reconnectionResponse, response);
            }
        ...
        reconnectionResponse = new ReconnectionResponse(null);
        reconnectionResponse.handle(handler);
    }
}