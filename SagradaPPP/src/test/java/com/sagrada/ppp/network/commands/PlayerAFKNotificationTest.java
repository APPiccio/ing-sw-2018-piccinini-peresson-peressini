...
public class PlayerAFKNotificationTest {

    PlayerAFKNotification playerAFKNotification;
    ...
    public void handle() {
        ...
        ResponseHandler handler = new ResponseHandler() {
            ...
            public void handle(PlayerAFKNotification response) {
                assertEquals(playerAFKNotification, response);
            }
        };

        playerAFKNotification = new PlayerAFKNotification(null, true, null);
        playerAFKNotification.handle(handler);
    }
}