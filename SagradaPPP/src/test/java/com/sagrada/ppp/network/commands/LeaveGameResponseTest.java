...
public class LeaveGameResponseTest {
    ...
    private LeaveGameResponse leaveGameResponse;
    @Test
    public void handle() {
        ...
        ResponseHandler handler = new ResponseHandler() {
            ...
            public void handle(LeaveGameResponse response) {
                assertEquals(leaveGameResponse, response);
            }
        ...
        leaveGameResponse = new LeaveGameResponse(null);
        leaveGameResponse.handle(handler);
    }
}