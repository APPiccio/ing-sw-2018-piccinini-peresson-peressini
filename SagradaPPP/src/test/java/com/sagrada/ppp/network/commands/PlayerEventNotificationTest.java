...
public class PlayerEventNotificationTest {

    PlayerEventNotification playerEventNotification;
    ...
    public void handle() {
        ...
        ResponseHandler handler = new ResponseHandler() {
            ...
            public void handle(PlayerEventNotification response) {
                assertEquals(playerEventNotification, response);
            }
        ...
        playerEventNotification = new PlayerEventNotification(123, "Analisi2", null, PlayerEventType.LEAVE);
        playerEventNotification.handle(handler);
    }
}