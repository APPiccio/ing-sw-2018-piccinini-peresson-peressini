...
public class SpecialDicePlacementResponseTest {

    SpecialDicePlacementResponse specialDicePlacementResponse;
    ...
    public void handle() {
        ...
        ResponseHandler handler = new ResponseHandler() {
            ...
            public void handle(SpecialDicePlacementResponse response) {
                assertEquals(specialDicePlacementResponse, response);
            }
        ...
        specialDicePlacementResponse = new SpecialDicePlacementResponse(null);
        specialDicePlacementResponse.handle(handler);
