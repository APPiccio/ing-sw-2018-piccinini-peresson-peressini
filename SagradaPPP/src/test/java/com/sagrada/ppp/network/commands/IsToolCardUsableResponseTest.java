...
public class IsToolCardUsableResponseTest {

    private IsToolCardUsableResponse isToolCardUsableResponse;
    ...
    public void handle() {
        ...
        ResponseHandler handler = new ResponseHandler() {
            ...
            public void handle(IsToolCardUsableResponse response) {
                assertEquals(isToolCardUsableResponse, response);
            }
        ...
        isToolCardUsableResponse = new IsToolCardUsableResponse(null);
        isToolCardUsableResponse.handle(handler);
    }
}