...
public class UseToolCardResponseTest {
    ...
    public void handle(){
        ResponseHandler responseHandler = new ResponseHandler() {
            ...
            public void handle(UseToolCardResponse response) {
                assertEquals(useToolCardResponse, response);
            }
        ...
        useToolCardResponse = new UseToolCardResponse(new UseToolCardResult(true, 1,
                1, null, null, null, null, null));
        useToolCardResponse.handle(responseHandler);
