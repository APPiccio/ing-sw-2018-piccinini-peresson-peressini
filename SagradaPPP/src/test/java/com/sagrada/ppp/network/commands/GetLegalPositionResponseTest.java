...
public class GetLegalPositionResponseTest {

    private GetLegalPositionResponse getLegalPositionResponse;
    ...
    public void handle() {
        ...
        ResponseHandler handler = new ResponseHandler() {
            ...
            public void handle(GetLegalPositionResponse response) {
                assertEquals(getLegalPositionResponse, response);
            }
        ...
        getLegalPositionResponse = new GetLegalPositionResponse(null);
        getLegalPositionResponse.handle(handler);
